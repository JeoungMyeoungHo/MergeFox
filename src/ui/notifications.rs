...
impl MergeFoxApp {
    ...
    /// "backup tag X points at the pre-reset HEAD", or the filter level
    /// and sparse list after a partial clone). The summary is what the
    /// user sees at a glance; the detail is revealed in the toast's
